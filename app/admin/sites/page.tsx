...
import AjouterSiteDialog from '@/components/site/ajouter-site';
import SiteList from '@/components/site/site-list';

export const metadata = { title: 'Sites — Admin SATE' };
        ...
        <div className="mx-auto max-w-7xl px-4 py-10 space-y-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <h1 className="mt-3 text-2xl font-bold text-white">Gestion des sites</h1>
              <p className="mt-1 text-sm text-gray-400">Créer et gérer les sites logistiques</p>
            </div>
            <AjouterSiteDialog />
          </div>
